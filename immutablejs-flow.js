...
declare module 'immutable' {
  ...
  declare function isCollection(maybeCollection: mixed): boolean %checks(maybeCollection instanceof
    Collection);
  declare function isKeyed(maybeKeyed: mixed): boolean %checks(maybeKeyed instanceof
    KeyedCollection);
  ...
  declare type RecordFactory<Values: Object> = Class<RecordInstance<Values>>;

  // The type of runtime Record instances.
  declare type RecordOf<Values: Object> = RecordInstance<Values> & $ReadOnly<Values>;
  ...
  declare function isRecord(maybeRecord: any): boolean %checks(maybeRecord instanceof
    RecordInstance);
